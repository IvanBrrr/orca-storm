...
describe('static AppImage package contract', () => {
  it.each([
    ...
    ['storca-linux.AppImage', 0x3e, 1],
    ['storca-linux-arm64.AppImage', 0xb7, 'arm64']
  ...
  it.each([
    ...
    ['storm arm64 filename for an x64 runtime and target', 'storca-linux-arm64.AppImage', 0x3e, 1],
    ['storm x64 filename for an arm64 runtime and target', 'storca-linux.AppImage', 0xb7, 3]
